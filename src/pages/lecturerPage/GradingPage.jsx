        ...
        <div className="relative px-4 sm:px-6 lg:px-8 pb-8 max-w-lg mx-auto">
          <div className="bg-white px-8 pb-6 rounded-b shadow-lg">
            ...
            <div className="text-center mb-6">
              ...
              <h1 className="text-xl leading-snug text-slate-800 font-semibold mb-2">Grading 🔥</h1>
            ...
            {card &&
              <div>
                <div className="space-y-4">
                  {/* Card Number */}
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="card-nr">Assignment <span className="text-rose-500">*</span></label>
                    <input id="card-nr" className="form-input w-full" type="text" placeholder="0, 0, 0, 0" />
                  </div>
                  {/* Expiry and CVC */}
                  ...
                  {/* Name on Card */}
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="card-name">Test <span className="text-rose-500">*</span></label>
                    <input id="card-name" className="form-input w-full" type="text" placeholder="0, 0, 0, 0" />
                  </div>
                  {/* Email */}
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="card-email">Exam <span className="text-rose-500">*</span></label>
                    <input id="card-email" className="form-input w-full" type="email" placeholder="0, 0, 0, 0" />
                  </div>
                </div>
                {/* htmlForm footer */}
                <div className="mt-6">
                  <div className="mb-4">
                    <button className="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white" href="#0">Save</button>
                  </div>
                  <div className="text-xs text-slate-500 italic text-center">The scores will be added to student records</div>
                </div>
              </div>
            }
