...
const AccountantAnalytics = () => {
  const location = useLocation();
  return (
    <div className='flex justify-around '>

    <div className="bg-slate-300 rounded-md text-center p-14 mr-16 ">
                    <div className="flex flex-col h-full">
                      <div className="grow mb-2">
                        ...
                        {/* Content */}
                        <h3 className="text-lg font-semibold text-slate-800 mb-1">Total Lectures</h3>
                        <div className="text-sm"> </div>
                        <h2 className="text-xlg font-semibold text-slate-800 mb-1"></h2>
                      </div>
                      {/* Link */}
                      <div>
                ...
                <div className="bg-slate-300 rounded-md text-center p-12 mr-16 ">
                    <div className="flex flex-col h-full">
                      <div className="grow mb-2">
                        {/* Icon */}
                        <div className="inline-flex w-12 h-12 rounded-full bg-indigo-400">
                        ...
                        {/* Content */}
                        <h3 className="text-lg font-semibold text-slate-800 mb-1">Total Fees paid</h3>
                        <div className="text-sm"></div>
                        <h2 className="text-xlg font-semibold text-slate-800 mb-1"></h2>
                      </div>
                      {/* Link */}
                ...
                <div className="bg-slate-300 rounded-md text-center  p-3 mx-8 px-16">
                    <div className="flex flex-col h-full">
                      <div className="grow mb-2">
                        {/* Icon */}
                        <div className="inline-flex w-12 h-12 rounded-full bg-indigo-400">
                        ...
                        {/* Content */}
                        <h3 className="text-lg font-semibold text-slate-800 mb-1">Total registered<br/>/semester</h3>
                        <div className="text-sm"></div> 
                ...
                {/* //   item in sections */}
                <div className="bg-slate-300 rounded-md text-center p-12 mr-16 mx-4 ">
                    <div className="flex flex-col h-full">
                      <div className="grow mb-2">
                        {/* Icon */}
                        <div className="inline-flex w-12 h-12 rounded-full bg-indigo-400">
                        ...
                        {/* Content */}
                        <h3 className="text-lg font-semibold text-slate-800 mb-1">Total Amount paid</h3>
                        <div className="text-sm"></div>
                        <h2 className="text-xlg font-semibold text-slate-800 mb-1"></h2>
                      </div>
                      {/* Link */}
