      ...
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full text-center p-5">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-slate-800 font-semibold mb-1">Number of courses</h3>
            <h3 className="text-xlg text-slate-800 font-semibold mb-1">40</h3>
          </div>
          <div>
      ...
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full text-center p-5">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-slate-800 font-semibold mb-1">Number of lecturers</h3>
            <h3 className="text-xlg text-slate-800 font-semibold mb-1">20</h3>
          </div>
          <div>
            {/* <a className="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">Explore -&gt;</a> */}
          </div>
        ...
        <div className="flex flex-col h-full text-center p-5">
          <div className="grow mb-1">
            ...
            <NavLink end to='/number/students'>
                <h3 className="text-xlg text-green-500  font-semibold mb-1">click to view-&gt;</h3> 
            </NavLink>
