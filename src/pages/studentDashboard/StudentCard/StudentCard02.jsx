...
function StudentCard02() {
  return (
    <div className="flex flex-col col-span-full xl:col-span-4 bg-slate-200 to-slate-800 shadow-lg box-shadow:rgba(9, 30, 66, 0.25) 0px 1px 1px, rgba(9, 30, 66, 0.13) 0px 0px 1px 1px rounded-lg ">
      <header className="px-5 py-4 border-slate-600 flex items-center">
        <h2 className="font-semibold text-black">PAYMENTS</h2>
      </header>
      <div className="h-full flex flex-col px-5 py-6">
        ...
        <div className="grow flex flex-col justify-center mt-3">
          <div className="text-xs text-black font-semibold uppercase mb-3">Details</div>
          <div className="space-y-2">
            <div>
              <div className="flex justify-between text-sm mb-2">
                <div className="text-black">Current Fees</div>
                <div className="text-black italic">
                  $780,00 <span className="text-black">/</span> $1,500.00
                </div>
              </div>
            ...
            <div>
            <div className="flex justify-between text-sm mb-2">
                <div className="text-black">Paid</div>
                <div className="text-black italic">
                  $780,00 <span className="text-black">/</span> $1,500.00
                </div>
              </div>
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                <div className="text-black">Oustanding</div>
                <div className="text-black italic">
                  $179,00 <span className="text-black">/</span> $1,000.00
                </div>
              </div>
              {/* <div className="relative w-full h-2 bg-slate-600">
